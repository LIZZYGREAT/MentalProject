...
<!-- ALEMBIC_HEAD: 0043_course_schedule_completion_presentation -->
...
当前 Alembic 唯一 head 是 `0043_course_schedule_completion_presentation`。0017 增加 Warning/Daily Review
