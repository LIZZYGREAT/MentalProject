...
<!-- ALEMBIC_HEAD: 0041_course_schedule_created_provider_id_guard -->
...
当前 Alembic 唯一 head 是 `0041_course_schedule_created_provider_id_guard`。0017 增加 Warning/Daily Review
