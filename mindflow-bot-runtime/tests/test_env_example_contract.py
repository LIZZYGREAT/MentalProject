...
def test_env_example_contains_critical_runtime_capabilities():
    required = {
        ...
        "WEB_READ_URL_ENABLED",
        "WEB_READ_URL_TIMEOUT_SECONDS",
        "WEB_READ_URL_MAX_BYTES",
        "WEB_READ_URL_MAX_REDIRECTS",
        "WEB_READ_URL_MAX_EXTRACTED_CHARS",
        "WEB_READ_URL_CACHE_TTL_MINUTES",
