...
FEATURE_SPECS: dict[str, dict[str, Any]] = {
    ...
    "morning_brief": {
        "title": "早报",
        "summary": "每天在你选择的时间，汇总今日日程和待办提醒。",
        "what": (
            "早报会汇总当天日程、你创建的提醒事项和一句固定轻提示；"
            "你可以自行开启、关闭、调整时间或暂停一周。"
        ),
        "how_to_say": (
            "每天早上 8 点给我早报",
            "看看早报设置",
    ...
    "reminder": {
        "title": "提醒",
        "summary": "按你指定的时间提醒一件具体的事。",
        "what": (
            "你可以创建一次性提醒，查看已有提醒，或取消自己创建的提醒。"
        ),
        "how_to_say": (
            "今晚 10 点提醒我交作业",
            "取消刚才那个提醒",
    ...
    "web_search": {
        "title": "联网搜索",
        "summary": "查询公共网页信息，并保留来源供你核对。",
        "what": (
            "需要最新公共信息时，可以通过后端受控的搜索服务查找网页证据。"
        ),
        "how_to_say": ("搜一下今天最新的 XXX",),
        "limits": (
            "只搜索公共信息，不会把你的私人日程、心理记录或身份信息带入查询。",
            "只有部署环境启用搜索后端时才会显示和可用。",
        ),
        "capability_flag": "web_search_enabled",
    },
    "memory": {
        "title": "长期记忆",
        "summary": "只保存你明确要求我长期记住的个人事实。",
        "what": (
            "你明确说“记住”时，我可以保存适合长期使用的偏好或背景；"
            "也可以查看、修改和删除这些记忆。"
        ),
        "how_to_say": (
            "记住我喜欢 FromSoftware 的游戏",
            "给我看看你的记忆",
        ),
        "limits": (
            "不会把心理状态、治疗或药物信息当作普通长期记忆保存。",
            "表达方式等交互规则会进入独立的偏好设置，而不是普通记忆。",
        ),
        "capability_flag": None,
    },
    "interaction_preferences": {
        "title": "表达与支持偏好",
        "summary": "设置回答长度、语气、建议方式和称呼偏好。",
        "what": (
            "你可以让回答更短、更温和，要求建议前先询问，"
            "也可以设置助手称呼和自称。"
        ),
        "how_to_say": (
            "以后回答短一点",
